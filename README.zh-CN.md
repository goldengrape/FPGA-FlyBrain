...
documentation-first 规范已经进入实现阶段。**LAB-HW-00~06** 已有中英文学生 Notebook 与 `boards/kv260/` support/runtime artifact；LAB-HW-05 已加入 PS/Linux first boot，LAB-HW-06 已加入第一条 PS↔PL MMIO loopback 教学路径。真实 KV260 T-HW evidence 与真实 Vivado LAB-HW-06 full-build dry run 仍待执行。
