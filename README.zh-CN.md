...
documentation-first 规范已经进入实现阶段。**LAB-HW-00~10** 已有中英文学生 Notebook 与 `boards/kv260/` support/runtime artifact；LAB-HW-10 已加入第一套 PL→DDR AXI CDMA 教学路径、deterministic contiguous-vs-small/scattered workload、integrity gate 与 two-batch reproducibility oracle。真实 KV260 T-HW evidence 与真实 Vivado LAB-HW-10 full build 仍待执行。
