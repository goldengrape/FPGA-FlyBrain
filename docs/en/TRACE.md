...
- LAB-HW-00~10: Physical Lab teaching structure, RMD mappings, and T-HW oracles are frozen; **LAB-HW-00~05** now have bilingual Notebooks and CI contract checks; LAB-HW-03/04 add board-specific RTL, Bank 45 XDC, build/program helpers, and open-source self-checking simulations, while LAB-HW-05 adds image-identity/UART/boot-evidence helpers. No real-KV260 pass or real Vivado full-build pass is claimed; LAB-HW-06~10 remain pending
