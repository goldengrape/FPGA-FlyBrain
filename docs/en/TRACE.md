...
- LAB-HW-00~10: Physical Lab teaching structure, RMD mappings, and T-HW oracles are frozen; **LAB-HW-00~06** now have bilingual Notebooks and CI contract checks; LAB-HW-03/04 add board-specific RTL, Bank 45 XDC, build/program helpers, and open-source self-checking simulations; LAB-HW-05 adds image-identity/UART/boot-evidence helpers; LAB-HW-06 adds the frozen PS→PL AXI-GPIO teaching path, transform RTL/testbench, Vivado build contract, and self-checking MMIO helper. No real-KV260 T-HW-006 pass or real Vivado LAB-HW-06 full build is claimed; LAB-HW-07~10 remain pending
