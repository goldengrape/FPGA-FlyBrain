...
| LSN-020 | Build a manifest/checksum network-image integrity contract while keeping teaching fixture ≠ formal MaleCNS artifact explicit | FR7/DP7 + PFR4 | `exercises/en/20_load_malecns_subset.ipynb` (grader: `exercises/grader/lesson20.py`); prepares T-014/015 | RMD-017/018 | `lessons/en/20_load_malecns_subset.ipynb` |
