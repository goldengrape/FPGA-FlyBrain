...
- The KV260 reference board and `LAB-HW-00~10` teaching/acceptance standards are frozen. **LAB-HW-00~02** now have bilingual Lab Notebooks, notebook-contract checks, and first `boards/kv260/scripts/` helpers. This does not claim a real-KV260 pass; LAB-HW-03~10 remain unimplemented.
