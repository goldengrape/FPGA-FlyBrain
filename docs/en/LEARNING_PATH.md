...
- The KV260 reference board and `LAB-HW-00~10` teaching/acceptance standards are frozen. **LAB-HW-00~06** now have bilingual Lab Notebooks and CI contracts. LAB-HW-03/04 cover first bitstream and physical clock/reset/I/O; LAB-HW-05 adds Ubuntu/UART runtime-host bring-up; LAB-HW-06 adds the first authoring-candidate PS/Linux MMIO ↔ PL loopback with a self-checking host script. This does not claim a real-KV260 pass, frozen Ubuntu archive hash, proven `/dev/mem` policy compatibility, or a real Vivado full-build pass; LAB-HW-07~10 remain unimplemented.
