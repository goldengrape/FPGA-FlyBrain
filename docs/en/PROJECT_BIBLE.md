...
They should have hands-on intuition for registers, RAM, FIFO, pipelines, fixed point, DDR bandwidth, sparse/event-driven computation, FPGA accelerators, and neuromorphic hardware.
