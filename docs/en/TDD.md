...
- bilingual-ID consistency check: **partially automated**; Exercise Notebooks and LAB-HW-00~06 enforce bilingual cell-structure/ID consistency
- KV260 Physical Lab contract checks: **implemented for LAB-HW-00~06**; CI checks bilingual Notebook structure, frozen XDC/board-helper contracts, LAB-HW-03/04/06 open-source RTL behavior, Tcl helper contracts where they can be exercised without Vivado, LAB-HW-05 image/boot helpers, and LAB-HW-06 dry-run/MMIO checker behavior. It does not claim a real Vivado LAB-HW-06 build or real-board roundtrip. It does not claim physical-board verification or a real Vivado full build.
