...
- KV260 Physical Lab contract checks: **implemented for LAB-HW-00~10**; CI checks bilingual Notebook structure, frozen XDC/board-helper contracts, LAB-HW-03/04/06/07/08 open-source RTL behavior, Tcl helper contracts where they can be exercised without Vivado, LAB-HW-05 image/boot helpers, LAB-HW-06 loopback dry-run, LAB-HW-07 BRAM-state checker, LAB-HW-08 fixture/reference/differential checker, and LAB-HW-09 DDR-integrity dry-run plus deliberate-corruption gate. CI does not claim a real Vivado LAB-HW-08 build or real-KV260 T-HW-007/008/009 physical PASS.
