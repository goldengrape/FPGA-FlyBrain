...
- KV260 reference board 与 `LAB-HW-00~10` 的教学/验收规范已完成 documentation-first 决策。**LAB-HW-00~02** 已建立双语 Lab Notebook、Notebook contract 检查与首批 `boards/kv260/scripts/` helper；这不代表真实 KV260 已通过，LAB-HW-03~10 尚未实现。
