...
- LAB-HW-00~10：Physical Lab 教学结构、RMD 映射与 T-HW oracle 已冻结；**LAB-HW-00~05** 已建立双语 Notebook 与 CI contract checks；LAB-HW-03/04 已加入 board-specific RTL、Bank 45 XDC、build/program helper 与 open-source self-checking simulation，LAB-HW-05 已加入 image identity、UART 与 boot-evidence helper。当前不宣称真实 KV260 或真实 Vivado full build 已通过；LAB-HW-06~10 仍待实现
