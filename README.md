...
The documentation-first design is now being implemented. **LAB-HW-00~06** now have bilingual student Notebooks and board-support artifacts under `boards/kv260/`. LAB-HW-05 adds the Ubuntu/UART runtime-host bring-up path; LAB-HW-06 adds the authoring-candidate PS/Linux MMIO ↔ PL loopback. Real-KV260 physical verification, image-hash promotion, and real Vivado full-build dry runs are still pending.
...
Planning, system architecture, and the first curriculum audit are complete. **The KV260 reference board and LAB-HW-00~10 physical-teaching/acceptance standards are frozen.** LAB-HW-00~06 now have bilingual Notebooks and CI contracts. LAB-HW-03/04 cover first bitstream and physical I/O; LAB-HW-05/06 cover PS/Linux boot and the first authoring-candidate host↔PL MMIO path. LAB-HW-07~10 and all real-board evidence remain pending. The first formal implementation slice has not yet been declared complete.
